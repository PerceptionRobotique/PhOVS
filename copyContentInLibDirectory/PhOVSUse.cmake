...
# Import PhOVS's build settings:
#CMAKE_IMPORT_BUILD_SETTINGS(${VISP_BUILD_SETTINGS_FILE})

# Tell the compiler where to find PhOVS's header files
# and the third party headers we depend on
#SET(PhOVS_EXTERN_INCLUDE_DIR "/usr/include")
LIST(APPEND PhOVS_INCLUDE_DIR)
MESSAGE("PhOVS_INCLUDE_DIR " ${PhOVS_INCLUDE_DIR})
INCLUDE_DIRECTORIES(${PhOVS_INCLUDE_DIR} )

# Tell the compiler where to find ViSP's libraries
# and the third party libraries we depend on
LINK_DIRECTORIES(${PhOVS_LINK_DIRECTORIES})

LINK_LIBRARIES(${PhOVS_LIBRARIES})
