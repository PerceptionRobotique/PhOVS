...
void
CFeatureLuminanceOmni::pureSphericalBuildFrom(vpImage<unsigned char> &I, vpImage<float> *Idepth)
{
...
void
CFeatureLuminanceOmni::cartesianSphericalBuildFrom(vpImage<unsigned char> &I, vpImage<float> *Idepth)
{
  static int firsttime =0 ;
...
*/
void
CFeatureLuminanceOmni::cartesianSphericalBuildFrom(vpImage<double> &I, vpImage<float> *Idepth)
{
  static int firsttime =0 ;
...
void
CFeatureLuminanceOmni::polarImagePlaneBuildFrom(vpImage<unsigned char> &I, vpImage<float> *Idepth)
{
  static int firsttime =0 ;
...
void
CFeatureLuminanceOmni::cartImagePlaneBuildFrom(vpImage<unsigned char> &I, vpImage<float> *Idepth)
{
  double Ix,Iy ;
