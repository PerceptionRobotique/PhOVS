...
void
CFeatureLuminanceOmni::pureSphericalBuildFrom(vpImage<unsigned char> &I, CFeatureLuminanceOmni *sd)
{
...
void
CFeatureLuminanceOmni::cartesianSphericalBuildFrom(vpImage<unsigned char> &I, CFeatureLuminanceOmni *sd)
{
  static int firsttime =0 ;
...
void
CFeatureLuminanceOmni::polarImagePlaneBuildFrom(vpImage<unsigned char> &I, CFeatureLuminanceOmni *sd)
{
  static int firsttime =0 ;
...
void
CFeatureLuminanceOmni::cartImagePlaneBuildFrom(vpImage<unsigned char> &I, CFeatureLuminanceOmni *sd)
{
  double Ix,Iy ;
